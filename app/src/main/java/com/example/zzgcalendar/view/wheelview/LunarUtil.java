...
public class LunarUtil {
    ...
    public static final String[] lunarHour = {"0(子)", "1(丑)", "2(丑)", "3(寅)", "4(寅)", "5(卯)", "6(卯)", "7(辰)", "8(辰)", "9(巳)",
            "10(巳)", "11(午)", "12(午)", "13(未)", "14(未)", "15(申)", "16(申)", "17(酉)", "18(酉)", "19(戊)",
            "20(戊)", "21(亥)", "22(亥)", "23(子)"};
     ...
     * 获取农历的日的中文
     *
     * @param hour day in number format, e.g. 1
     *             day should be in range of [1, 21]
     * @return hour in Hanzi format, e.g. 初一
     */
    public static String getLunarNameOfHour(int hour) {
        if (hour > 0 && hour < 24) {
            return lunarHour[hour - 1];
        } else {
            throw new IllegalArgumentException("day should be in range of [1, 24] hour is " + hour);
        }
    }
    ...
    public static String[] getArrayForLength(int length) {
