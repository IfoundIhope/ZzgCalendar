package com.example.zzgcalendar.view;
...
import com.example.zzgcalendar.view.wheelview.ItemsRange;
import com.example.zzgcalendar.view.wheelview.OnWheelChangedListener;
import com.example.zzgcalendar.view.wheelview.OnWheelClickedListener;
import com.example.zzgcalendar.view.wheelview.OnWheelScrollListener;
import com.example.zzgcalendar.view.wheelview.WheelRecycle;
import com.example.zzgcalendar.view.wheelview.WheelScroller;
 ...
 */
public class BirthWheelView extends BaseWheelView {
...
//        private int wheelForeground = R.drawable.wheel_val;
    ...
    private int wheelForeground = R.drawable.wheel_val;
         ...
         * Constructor
         */
        public BirthWheelView(Context context, AttributeSet attrs, int defStyle) {
         ...
         * Constructor
         */
        public BirthWheelView(Context context, AttributeSet attrs) {
            super(context, attrs);
            initData(context);
        }
